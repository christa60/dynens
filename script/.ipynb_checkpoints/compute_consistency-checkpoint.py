...
parser.add_argument("-d", "--trainingdistr",
                    help="training distribution file", required=False)
parser.add_argument("-pc", "--percentage",
                    help="majority percentage, default is 0.98", default=0.98, required=False)
...
if trainingdistr is not None:
    ...
    newlist = sorted(dict_classes.items(),
...
print('{},{},{},{},{},{},{},{},{},{},{}'.format(majority_er, minority_er, er,
                                                crl, er_ea, pearson, cosine, ea_er, cr, majority_ea_er, minority_ea_er))
if outputfile:
    f = open(outputfile, 'a')
    f.write('{},{},{},{},{},{},{},{},{},{},{},{},{}\n'.format(predfile1, predfile2, majority_er,
                                                              minority_er, er, crl, er_ea, pearson, cosine, ea_er, cr, majority_ea_er, minority_ea_er))
    f.close()
